...
public class CocinaService {
    ...
    private CocinaService(Chef chef, Despensa despensa) {
        this.chef = chef;
        this.despensa = despensa;
    }

    public static synchronized CocinaService getInstance(Chef chef, Despensa despensa) {
        if (instancia == null) {
            instancia = new CocinaService(chef, despensa);
        }
        return instancia;
    }
